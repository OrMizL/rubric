...
export function buildUserPrompt(input: PromptInput): string {
  ...
  const intent = [`# PR intent`, ``, `Title: ${input.title}`, ``, `Description:`, input.body.trim() || "(no description provided)"];
  ...
  sections.push(`Produce your structured review of whether this implementation matches its stated intent.`);
